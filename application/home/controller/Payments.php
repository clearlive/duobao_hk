...
class Payments extends Controller{
	...
	public function mq_notify(){
        ...
        if($key == $notify_key){
            ...
            //
            //
            $balancetemp = db('recharge')->where('balance_sn',$orderid)->where('isverified',0)->find();
            $a = $this->notify_ok_hui($orderid,$balancetemp['pay_type'],$balancetemp['bpprice']);
